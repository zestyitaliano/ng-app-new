    ...
    <div ref={containerRef} className="flex-1 bg-gray-50 p-4 md:p-8 overflow-y-auto h-full">
      <div className="max-w-7xl mx-auto flex flex-col min-h-full">
        <div className="mb-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Top Exported Palettes</h2>
          <p className="text-gray-500">The most downloaded color combinations by the community.</p>
        </div>
